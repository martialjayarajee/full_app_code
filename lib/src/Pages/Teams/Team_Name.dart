...
import 'package:full_app_code/src/Pages/Teams/InitialTeamPage.dart';
...
class _TeamNameScreenState extends State<TeamNameScreen> {
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  onPressed: () async {
                            String teamName = teamNameController.text.trim().toUpperCase(); // Add .toUpperCase()
                            ...
                            if (!_isValidTeamName(teamName)) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text('Team name should not contain numbers!'),
                                  backgroundColor: Colors.red,
                                  duration: Duration(seconds: 2),
                                ),
                              );
  ...
  void _editTeam(int index) {
    final TextEditingController editController = TextEditingController(text: teams[index].name);
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                   onPressed: () async {
  String teamName = editController.text.trim().toUpperCase(); // Add .toUpperCase()
              ...
              bool teamExists = teams.any((team) => 
              ...
              final updatedTeam = Team(name: teamName, players: teams[index].players);
                                          ...
                                          itemBuilder: (context, index) {
                                            return InkWell(
                                              onTap: () async {
                                                ...
                                                // Reload teams when returning from members screen
                                                await _loadTeams();
                                              },
                                              child: Container(
